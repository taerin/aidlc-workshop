...
- **Total Stages**: 4 (User Stories → Application Design → Code Generation → Build and Test)
- **Stages to Execute**: User Stories, Application Design, Code Generation, Build and Test
